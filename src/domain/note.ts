...
export const NATURAL_PITCH_INDICES: PitchIndex[] = [0, 2, 4, 5, 9, 11];
export const PITCH_REGESTRY: Record<PitchIndex, NotePitch> = {
  0: "C",
  1: "C",
  2: "D",
  3: "D",
...
export function fromMidi(midi: MidiValue): Note {
  ...
  const pitch = PITCH_REGESTRY[index]
...
export function generatorNotes({
  fromNote = LOWER_NOTE,
  toNote = HIGHER_NOTE
...
export const notes = generatorNotes()
